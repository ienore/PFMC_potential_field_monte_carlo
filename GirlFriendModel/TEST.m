...
scatter(( mc_result_J_factor)/mean( mc_result_J_factor),mc_result_energy,5,'blue','filled')
hold on
scatter((mc_result_C_factor )/mean(mc_result_C_factor ),mc_result_energy,5,'filled','r')
...
title("Energy vs Nearest Neighbor Summation")
xlabel("Nearest Neighbor Summation")
ylabel("Energy")
